<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <h3 class="text-white text-uppercase">{{projectShortName()}}</h3>
            </span>
            <span class="logo-lg">
                <h3 class="text-white text-uppercase mt-2">{{projectName()}}</h3>
            </span>
        </a>
        <!-- Light Logo-->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarFinance">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountsList', 'Exchange') }}" class="nav-link"
                                    data-key="t-pickers">
                                    Exchange Accounts </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('vendorPayments.index') }}" class="nav-link"
                                    data-key="t-input-masks">Vendor Payment</a>
                            </li>
                            <li class="nav-item">
