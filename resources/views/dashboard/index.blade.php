                ...
                <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                    <div class="col">
                        @php
                            ...
                            $myBalance = myBalance();
                            $exchangesBalance = exchangeBalance();
                        @endphp
                        <div class="py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Purchases PKR</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">{{totalPurchases()}}</h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Purchases Toman</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">{{totalPurchasesToman()}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">{{totalSales()}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$customersBalance < 0 ? "text-danger" : "text-success"}}">{{$customersBalance}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$vendorsBalance < 0 ? "text-danger" : "text-success"}}">{{$vendorsBalance}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Exchanges Balance</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$exchangesBalance < 0 ? "text-danger" : "text-success"}}">{{$exchangesBalance}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$myBalance < 0 ? "text-danger" : "text-success"}}">{{$myBalance}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">{{stockValue()}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Whatsapp Balance</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">$ {{getWhatsappBalance()}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
        ...
        <div class="card">
            ...
            <div class="card-header p-0 border-0 bg-light-subtle">
                <div class="row g-0 text-center">
                    ...
                    <div class="col-6 col-sm-3">
                        <div class="p-3 border border-dashed border-start-0">
                            <h5 class="mb-1"><span class="counter-value" data-target="{{round($last_expense)}}">0</span></h5>
                    ...
                    <div class="col-6 col-sm-3">
                        <div class="p-3 border border-dashed border-start-0">
                            <h5 class="mb-1"><span class="counter-value" data-target="{{round($last_profit)}}">0</span></h5>
                    ...
                    <div class="col-6 col-sm-3">
                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                            <h5 class="mb-1 text-success"><span class="counter-value" data-target="{{round($last_profit - $last_expense)}}">0</span></h5>
                    ...
                    <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <h5 class="fs-14 my-1">{{$product['code']}}</h5>
                                        <h5 class="fs-14 my-1">{{$product['color']}}</h5>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <h5 class="fs-14 my-1 fw-normal">
                                        ...
                                        {{number_format($product['sold'], 2)}} Nos
                                        @else
                                        {{number_format(sqFeets($product['sold']), 2)}} SQM
                                        @endif
                                    </h5>
                                ...
                                <td>
                                    <h5 class="fs-14 my-1 fw-normal">
                                        @if ($product['cat'] == 'Kaleen')
                                        {{number_format(getStock($product['id']), 2)}} Nos
                                        @else
                                        {{number_format(sqFeets(getStock($product['id'])), 2)}} SQM
                                        @endif
                                    </h5>
