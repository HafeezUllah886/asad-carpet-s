                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" oninput="updateTotal()" min="0" id="discount" value="0"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" oninput="updateTotal()" name="dc" min="0" id="dc" value="0"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total" min="0" id="total" readonly value="0"
                                        class="form-control">
                                </div>
                            </div>
