...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('vendorPayments', VendorPaymentsController::class);
    Route::get('vendorPayment/delete/{ref}', [VendorPaymentsController::class, 'delete'])->name('vendorPayment.delete')->middleware(confirmPassword::class);
